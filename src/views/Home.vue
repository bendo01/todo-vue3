  ...
  <div class="bg-white rounded shadow p-6 m-4 w-full lg:w-3/4 lg:max-w-lg">
    <div class="mb-4">
      ...
      <div class="flex mt-4">
        ...
        <button class="flex-no-shrink p-2 border-2 rounded text-green-500 border-green-500 hover:text-white hover:bg-green-500">
    ...
    <div id="model_list">
      <div class="flex mb-4 items-center" v-for="model in models" v-bind:key="model.id">
        <p class="w-full text-grey-darkest">{{ model.description }}</p>
...
export default {
  ...
  methods: {
    getTask() {
      const api = 'http://todo.test/api/todos';
